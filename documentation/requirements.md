...
*   **P0 Error Handling:** 
    ...
    *   **Timeout (P0):** If the Gemini API response takes longer than **30 seconds**, the request should be cancelled, and a "Request timed out. Please try again." message should be shown in the popup.
